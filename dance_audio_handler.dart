...
class DanceAudioHandler extends BaseAudioHandler with QueueHandler, SeekHandler {
  DanceAudioHandler({
  ...
  static Future<DanceAudioHandler> init({
    ...
    final handler = DanceAudioHandler(
      engine: engine,
      bus: bus,
      announcements: announcements,
    );
    ...
    return AudioService.init(
      ...
      config: const AudioServiceConfig(
        androidNotificationChannelId: 'com.example.dancedeck.audio',
